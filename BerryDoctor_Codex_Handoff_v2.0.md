...
> **22B Labs | MIT License | The 4th Path: ⟨H⊕A⟩ ↦ Ω**
...
> **외부 서비스 가입 필요: 0개**
> 카카오톡 채널은 22B Labs가 운영하며, 농부는 "친구 추가"만 함
...
> 모든 API는 공공데이터포털 무료 API키 사용 (22B Labs가 발급, 농부 발급 불필요)
...
| **5** | +4주 | 동생분 농장 1시즌 실증 + 피드백 반영 | v1.0 공개 릴리즈 |
