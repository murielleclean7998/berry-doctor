...
20개 테스트가 파서, 규칙 엔진, DB, 보안, 센서 집계, CSRF, dedupe를 검증합니다.
...
설치 후 대시보드 설정에서 `local_llm_model_path`에 GGUF 모델 경로를 지정하면 활성화됩니다.
